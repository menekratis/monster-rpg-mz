...
A service migration fails. A town’s safest machine may be forcing living synthetic companions to remember the wrong lives. The player follows creatures moving backward through a bright technological landscape and learns that preserving a person is not the same as restoring an approved version of them.

The story should make the player curious before it asks them to absorb lore. The immediate question is simple—**where did the returning wildkin go?**—while the deeper questions unfold over several places:

- Why does the Hush appear beside systems built to protect public networks and wildkin continuity?
- Why do affected wildkin repeat obsolete work routines and accept commands nobody admits sending?
- What did the region choose to forget after the Red Wake?
- Who authored seedcores, Accord, and the root permissions beneath them?
- Can the Chorus be made safe without giving one institution the power to define a creature’s valid self?

## Themes

### Care versus control

The story does not argue that all technology or intervention is bad. It asks when maintenance becomes control, who is allowed to define continuity, who accepts its costs, and whether essential infrastructure can be reformed rather than destroyed.

### Memory lives in practice

Routes, open protocols, work songs, creature migrations, repair traditions, personal modifications, and local stories preserve knowledge. When a sealed authority replaces them with one approved state, a community can lose both technical resilience and lived identity.

### Listening is an active skill

The protagonist succeeds by observing patterns, reading creatures beyond their registered functions, testing interpretations, and taking other people’s fears seriously. Listening does not mean passivity, obedience, or universal agreement.

### Made life is still life

The story begins from the position that wildkin attachments, preferences, pain, and growth are real. The mystery of manufacture does not invalidate them. Horror comes from people and systems treating identity as a restore point, product lineage, or licensed configuration.

### Why these themes

These themes turn the monster-catching premise into story action: understanding behavior, technical function, and consent matters in Accord, exploration, battle, and moral conflict. They also allow an antagonist institution whose actions make sense instead of a disposable “evil team.”

## World truth: layers of certainty

### Established for the vertical slice

- Wildkin are living synthetic beings whose grown seedcores retain body patterns, learned routines, relationship permissions, and persistent identity.
- The **Chorus** is a region-wide ecological communications lattice carried through seedcores, migrations, water, root systems, waybells, public relays, and wildkin calls.
- The **Hush** is not ordinary silence or infection. In a Hush pocket, ambient systems thin, grown material develops checksum rings, and wildkin roll back into older behavior.
- **Stillpoints**, maintained by the Meridian Office, stabilize dangerous network cascades by holding infrastructure and connected seedcores to verified continuity states.
- Concentrated Stillpoint activity can overwrite recent adaptation or displace rollback into nearby routes. Some Meridian field staff know anomalies occur, but root permissions and full incident data are compartmentalized.
- Accord is openly mutual at the companion layer. The slice establishes evidence of a deeper credential path that can bypass present consent.
- The opening crisis can be solved by combining a community-readable protocol with Meridian’s precise controls; neither “destroy the machine” nor “trust the machine” is sufficient.

### Strong full-game hypothesis, not yet locked

The Chorus carries distributed route memory and is capable of generating or recombining viable seedcore patterns. It began as designed infrastructure but has become an ecology no single maker controls. Stillpoints do not merely suppress dangerous traffic; they select which cached states count as valid. The discarded adaptation reappears downstream as Hush pockets and eventually as “wake” events.

Meridian’s leadership discovered the rollback depth gradually and concealed uncertainty because Stillpoints demonstrably saved settlements and bonded wildkin during the **Red Wake**, a synchronization disaster roughly twenty years ago. Their central mistake is treating living identity as continuity data with acceptable loss and believing secrecy is necessary to prevent uncontrolled root access.

### Deeper reveal options to test later

Only one of these should become canon after the slice:

1. The Red Wake was caused or worsened by a mass rollback intended to disable an unlicensed Reweave, making Meridian’s founding rescue inseparable from its predecessor’s mistake.
2. The Red Wake was an autonomous Chorus adaptation that threatened infrastructure but created new wildkin identities; leadership labeled it corruption and built permanent authority around suppressing recurrence.
3. Current society did not create seedcores. It inherited a world-building system whose root network still follows the objectives of vanished makers.
4. Accord descends from an old labor-control protocol that wildkin evolution transformed into mutual consent; Meridian retains the pre-consent branch.
...
- **Curious:** ask what does not fit.
- **Practical:** ask what needs to happen next.
...
Hearthmere’s bellfruit orchards rely on the spring return of Thrumble swarms for pollination and local mesh timing. Their arrival is also the town’s small annual resynchronization festival. This year, the shell-relays broadcast, but no swarm appears. The old weir begins to handshake at the wrong interval, service wildkin execute retired routines, and a pale Hush front creeps along the Sunken Track.
...
Hearthmere is prepared for a bright public resynchronization but trying not to panic. Transit boards flicker, Rillips keep fountains clean, and Latchlings steal festival access ribbons. Tavi turns the interruption into a competition: whoever finds the first true sign of the swarm gets to authorize the Return relay. Mara instead assigns both apprentices to survey the Sunken Track.

Meridian continuity engineer Merrit Quill is already present with a mobile Stillpoint. Merrit is calm, useful, and not framed as sinister. When a pressure-and-synchronization surge hits the old weir, the unit genuinely prevents structural damage and safely halts several panicked maintenance wildkin.

**Question created:** if the rollback saved them, why did wildkin avoid its handshake before the surge—and why did Merrit have it authenticated in advance?
...
After the player wins, Tavi grants one attempt and helps rather than sulking.
...
3. broadcast the restored consent interval and wait for Orralume’s voluntary response while answering a final forced rollback.

Orralume is not recruitable here. Reducing Resolve and completing the Tune ends the battle without knocking it unconscious.

### Beat 8 — The return, changed

Orralume accepts the open route and leads the Thrumble through the gorge. The orchard mesh returns, autonomous transit resumes, blossoms open, the weir vents, and Hearthmere holds a smaller dusk celebration. The local arc resolves visibly.
...
- **Who:** an autonomous synthetic migration coordinator and living participant in the local Chorus, carrying a service identity older than the known registry.
- **Why fight:** it is trapped in a harmful feedback loop and the weir is nearing failure.
- **What the player learned:** how to expose a consent interval and let Orralume choose the route rather than shut the system off or seize control.
- **What changes on victory:** the migration returns, the immediate danger ends, and the Hush becomes a regional mystery.
- **Mechanical expression:** three behavior phases require Guard, Break, and Tune responses learned across the slice.
...
| Root-format key retrieved by Latchling | “The Borrowed Key” side quest | Old hardware was reused | Meridian’s credential format predates its official founding | No |
| Merrit names Orralume before being introduced to it | Orchard dialogue | Expertise | Merrit was briefed on predicted effects for an unregistered coordinator | Subtle, no |
...
## Provisional broader shape

### Movement I — Wakes in the Vale

Several local arcs show wildkin in transport, fabrication, security, research, domestic life, and independent communities—not only pastoral habitats. Major battles vary: a rescue, a public team-and-transit contest with access stakes, an industrial Reweave refusal, a territorial cradle guardian, and a confrontation with a person the player trusts. The player gains evidence that Hush events are targeted rollbacks, not random faults.

### Movement II — Lines beneath the map

The player reaches fabrication districts, independent wildkin communities, older cradle infrastructure, and Meridian continuity records. Tavi’s family history, Mara’s revoked local credentials, Merrit’s divided loyalty, and the Open Chorus movement become central. The institution contains reformers, fearful local staff, rights advocates, and leaders protecting a public story and a genuinely dangerous key.
...
- Reserve portraits, unique music, and longer pauses for the Tavi confrontation, Orralume recovery, and aftermath.

## Story playtest questions

1. By the orchard, can players state the immediate problem without consulting the quest log?
2. Do players suspect Merrit because of evidence, or only because the genre trained them to distrust institutions?
3. Does Tavi’s control-platform decision feel understandable even when the player disagrees?
4. Is Orralume perceived as a creature being helped, not simply a boss blocking progress?
5. Which optional clues are noticed, and what theories do they produce?
6. Does the celebration feel like resolution, or does the stinger erase the satisfaction?
